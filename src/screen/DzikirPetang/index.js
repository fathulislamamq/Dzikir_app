...
class DzikirPetang extends React.Component {
  ...
  render() {
    return (
      <View style={{flex: 1}}>
        <View style={{height: 50, width: '100%', backgroundColor: '#FFFFFF', justifyContent: 'center', alignItems: 'center', elevation: 5, marginBottom: 5}}>
          <Text style={{fontWeight: 'bold', fontSize: 16, color: '#444444'}}> Dzikir Petang</Text>
        </View>
